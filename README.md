...
The PDF file astrostats_2017_ESAC.pdf contains the slides from the lecture, covering and overview of Gaia, GDR1, and most of the background theory to the statistics. 
